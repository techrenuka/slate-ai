        ...
        <div className="w-full max-w-3xl mx-auto px-4 mb-8">
          <div className="relative">
            <input
              ...
              className="w-full bg-[#222] text-white placeholder-gray-400 px-12 py-4 rounded-lg
                border-2 border-[#333] focus:border-[#00A6FF] outline-none transition-all duration-300
                hover:border-[#444]"
          ...
          <div className="w-full">
            ...
            <div>
              ...
              <div className="relative w-full">
                <div ref={scrollContainerRef} className="scroll-container flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth [scrollbar-width:none] hide-scrollbar">
